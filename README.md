...
I made this program to test this conjecture (and to satisfy my own curiosity). Input two numbers and it will calculate the collatz conjecture for every number between them. The full source and its visual studio project are available here.
